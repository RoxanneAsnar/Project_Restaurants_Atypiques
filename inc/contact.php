    ...
    <div id="contact">
        ...
        <div id="form1">
            <form action="" method="post" role="form" id="message-form" class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea name="textarea" class="form-control col-xs-12 col-sm-12 col-md-12 col-lg-12" name="message" id="text-area1" type="text" required></textarea>
        ...
        <div id="form2">
            <form action="" method="post" role="form" id="join-us-form" class="row">
                <h3 class="form">Nous rejoindre</h3>
                <div class="form-group">
                    ...
                    <textarea name="textarea" class="form-control col-xs-12 col-sm-12 col-md-12 col-lg-12" name="message" id="text-area2" type="text" placeholder="Votre message" required>
                    </textarea><br/>
                    <button type="submit" class="btn btn-primary send" id="send">Envoyer</button>
                </div>
            </form>
        </div>
    </div>
