<div id="concept" class="row">
    <div id="container-text" class="offset-md-2 offset-sm-1 col-xs-12 col-sm-10 col-md-8 col-lg-6">
        ...
        <p id="our-concept">
            ...
            Notre concept est simple: rassembler tous les restaurants qui proposent un cadre original, un menu (d)étonnant et les mettre en relation avec les clients désireux de nouvelles expériences gastronomiques.
        </p>
    </div>
</div>