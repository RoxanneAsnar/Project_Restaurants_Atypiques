<div id="creators">
    <div class="row" id="crea">
        <h2 id="titre-createurs">Un mot des créateurs</h2>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
            <div class="roundedImage"><img src="img/damien.jpg" alt="Damien Dupont"></div>
            <div class="creators-text-container">
                <h3 class="nom">Damien DUPONT</h3>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
            <div class="roundedImage"><img src="img/julien.jpg" alt="Julien Dupond"></div>
            <div class="creators-text-container">
                <h3 class="nom">Julien DUPOND</h3>
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            ...
            <div class="creators-text-container">
                <h3 class="nom">Laurent DUPONS</h3>
